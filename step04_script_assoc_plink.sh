...
Rscript ../merge.R m94samples_diabetes_snps_assoc_significant_annot_tmp.tsv annovar.hg38_multianno.txt SNP Probe_Set_ID m94samples_diabetes_snps_assoc_significant_annot.tsv
...
Rscript ../merge.R m94samples_all_snps_assoc_significant_annot_tmp.tsv annovar.hg38_multianno.txt SNP Probe_Set_ID m94samples_all_snps_assoc_significant_annot.tsv
